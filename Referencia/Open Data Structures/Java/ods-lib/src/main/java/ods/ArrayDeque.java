 ...
 * at a[(j+i)%a.length]. Insertions and removals at position i take O(1+min{i,
 * size()-i}) amortized time.
 *
 * @author morin
 *
 * @param <T> the type of objects stored in this list TODO: Implement addAll()
 * and removeAll() efficiently
 */
