...
/**
 * This class implements a priority queue as a class binary heap stored
 * implicitly in an array
 *
 * @author morin
 *
 * @param <T>
...
public class BinaryHeap<T> extends AbstractQueue<T> {
    ...
    /**
     * Move element i down in the heap until the heap property is restored
     *
     * @param i
     */
