...
/**
 * Implements the List<T> interface using two Lists so that insertion/deletions
 * at the front or back of the list are fast. This can be used as an efficient
 * Deque.
 *
 * @author morin
 *
...
public class DualArrayDeque<T> extends AbstractList<T> {
     ...
     *
     * Subclasses should override this if they want to use different structures
     * for front and back.
     *
     * @return
     */
    ...
    public static void main(String args[]) {
        List<Integer> l = new DualArrayDeque<>(Integer.class);
        for (int i = 0; i < 20; i++) {
            l.add(i);
        }
