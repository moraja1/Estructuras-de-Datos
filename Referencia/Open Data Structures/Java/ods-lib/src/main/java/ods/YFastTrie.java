...
public class YFastTrie<T> implements SSet<T> {
    ...
    protected static class STreap<T> extends Treap<T> {
        ...
        /**
         * Split this treap into a new treap containing all elements less than
         * or equal to x and leave all elements greater than x in the current
         * treap -- assumes x is contained in the current treap
         *
         * @param x
         * @return
         */
        ...
        /**
         * Absorb the elements of treap t, which should all be smaller than all
