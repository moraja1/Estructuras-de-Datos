...
/**
 * An implementation of the List interface as a doubly-linked circular list of
 * blocks of size b
 *
 * @author morin
 *
...
public class SEList<T> extends AbstractSequentialList<T> {
    ...
    /**
     * Call this function on a node u such that u and its b-1 successors all
     * contain b+1 items. This adds a new node so that u and its b successors
     * each contain b items
     *
     * @param u
     * @return
     */
    ...
    /**
     * Call this function on a node u such that u and its b-1 successors all
     * contain b-1 items. This removes a node so that u and its b-2 successors
     * each contain b items
     *
     * @param u
     * @return
