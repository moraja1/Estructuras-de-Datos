package cr.ac.una.service.util;
...
public class PathUtils {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("Resources directory: \t'%s'%n", getResourcesDirectory());
        System.out.printf("Resources directory: \t'%s'%n", getResourceDirectory("ejemplo.txt"));
        System.out.println();
